        ...
        .on("data", function (chunk) {
          ...
          if (chunk.status === "ok") {
            const embed1 = new Discord.MessageEmbed()
              .setColor("#2F3136")
              .setTitle(`Verified!`)
              .setDescription(`You have been verified with RoVer!`)
              .setFooter(
            ...
            const embedErr1 = new Discord.MessageEmbed()
              ...
              .setDescription(`An error occurred when trying to verify you!`)
              .setFooter(
                `Nightly ${package.build} ${package.version}`,
                client.user.displayAvatarURL()
              );
            ...
            interaction.member.roles.add(role).catch((e) => {
              interaction.update({ embeds: [embedErr1], components: [] });
            });

            interaction.member
              .setNickname(chunk.robloxUsername)
              .catch((e) => {});
          } else {
            const embed1 = new Discord.MessageEmbed()
              .setColor("#2F3136")
